...
@Client.on_message(
    command(["gel", f"gel@{BOT_USERNAME}"]) & other_filters
)
@check_blacklist()
...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "✅ Asistan katıldı..")
    except UserAlreadyParticipant:
        return await user.send_message(chat_id, "✅ Asistan zaten sohbette")


@Client.on_message(
    command(["git", f"git@{BOT_USERNAME}"]) & other_filters
)
@check_blacklist()
@authorized_users_only
...
async def leave_all(client, message):
    ...
    msg = await message.reply("🔄 Asistan gruptan ayrılıyor. !")
...
async def start_group_call(c: Client, m: Message):
    ...
    try:
        ...
        await msg.edit_text("✅ Akış başladı.. !")
...
async def stop_group_call(c: Client, m: Message):
    ...
    if not (
        ...
        await msg.edit_text("❌ Akış zaten sona erdi.")
        return
    await user.send(
        DiscardGroupCall(
            call=group_call
    ...
    await msg.edit_text("✅ Akış sona erdi. !")
